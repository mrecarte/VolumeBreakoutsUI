...
# Base directory is VolumeBreakoutsUI/backend
...
TEMPLATES = [
    {
        ...
        # Note: We go up one directory (..), then into frontend/dist
...
# Static files
STATIC_URL = '/static/'
# Again, note the '..' to go up one directory to access frontend/dist/static
